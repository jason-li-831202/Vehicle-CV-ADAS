...
try :
	...
	from ..utils import ModelType, OffsetType, lane_colors, tusimple_row_anchor, culane_row_anchor
...
class ModelConfig():
	...
	def __init__(self, model_type):
		...
		if model_type == ModelType.UFLDV2_TUSIMPLE:
...
class UltrafastLaneDetectorV2():
	_defaults = {
		...
		"model_type" : ModelType.UFLDV2_TUSIMPLE,
	}
	...
	def __init__(self, model_path=None, model_type=None):
		...
		if ( self.model_type not in [ModelType.UFLDV2_TUSIMPLE, ModelType.UFLDV2_CULANE]) :
